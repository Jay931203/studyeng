...
- `영어 공부 앱`보다 `자막, 저장, 반복으로 이어보는 영어 피드`
- `숏폼 학습 앱`보다 `짧게 보다 보면 귀가 익숙해지는 피드`
...
- 역할: 서비스 첫 인상
- 전달해야 할 것: "공부 앱"보다 "자꾸 보게 되는 영어 피드"
- 좋은 문장:
  - `보다 보면 귀가 먼저 익숙해집니다`
  - `오늘 장면, 저장 표현, 이어보기 흐름`
...
- 역할: 가장 강한 브랜드 경험
- 전달해야 할 것: 짧고 몰입되는 피드 소비 + 자막 + 반복 + 저장
- 좋은 문장:
  - `장면`
  - `지금 바로 보기`
...
3. `학습`, `미션`, `스트릭`, `워크플로우`, `장면 앱` 같은 용어가 다시 들어오지 않았는가
