/**
 * Surface Form Finder - batch 1
 * Reads C:/tmp/sf-batch-1.json (744 entries)
 * Outputs to src/data/match-results-v3/batch-1.json
 */
import fs from 'fs';
...
// Build reverse lookup: conjugated form → base(s)
...
// ── Main ──────────────────────────────────────────────────────────────────────
const inputPath = 'C:/tmp/sf-batch-1.json';
const outputDir = 'C:/Users/hyunj/studyeng/src/data/match-results-v3';
const outputPath = path.join(outputDir, 'batch-1.json');
