  ...
  return (
    <AnimatePresence>
      {xpDelta !== null && (
        ...
        >
          <div className="flex items-center gap-2 rounded-full bg-gradient-to-r from-yellow-500/90 to-orange-500/90 px-5 py-2.5 text-white shadow-lg shadow-yellow-500/30 backdrop-blur-sm">
            <motion.span
              ...
              className="text-lg"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 text-yellow-200">
