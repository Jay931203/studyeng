...
import { getMonthlyActivityExplainer } from '@/lib/learningDashboard'
import {
...
function formatMonthLabel(monthKey: string, locale: SupportedLocale) {
    ...
    <AppPage>
      <div className="mx-auto max-w-3xl space-y-4">
        ...
        <SurfaceCard className="p-5">
          <p className="text-sm text-[var(--text-secondary)]">{getMonthlyActivityExplainer(locale)}</p>
          <div className="mt-4 rounded-2xl border border-[var(--border-card)] bg-[var(--bg-secondary)]/30 px-4 py-3">
            ...
            <p className="mt-1 text-[11px] text-[var(--text-muted)]">
              {T.monthlyActivityHint(MONTHLY_ACTIVE_THRESHOLD)}
            </p>
          </div>
        </SurfaceCard>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between gap-3">
                    ...
                    >
                      {active ? T.criteriaMet : T.criteriaNotMet}
                    </span>
                  </div>
                  ...
                  <div className="mt-3 grid gap-3 sm:grid-cols-2">
                    <div>
                      <div className="mb-1 flex items-center justify-between text-[11px]">
                        <span className="text-[var(--text-secondary)]">{T.activityXp}</span>
                    ...
                    <div className="rounded-2xl bg-[var(--bg-card)] px-3 py-2">
                      <p className="text-[10px] text-[var(--text-muted)]">{T.lockedTierAtTime}</p>
