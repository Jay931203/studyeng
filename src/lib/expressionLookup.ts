 ...
 * Avoids importing the large (~4MB) expression-dictionary.json at runtime.
 *
 * Data files are generated by `scripts/build-expression-index.mjs`:
 *   - expression-entries.json  (212K) – expression metadata keyed by id
 *   - expression-index.json    (2.6M) – videoId -> [{exprId, sentenceIdx, en, ko}]
 */

import expressionEntriesData from "@/data/expression-entries.json";
import expressionIndexData from "@/data/expression-index.json";
